...
<header class="banner border-b border-gray-200 flex justify-between items-center sticky top-0 z-50 bg-white">
  ...
  <div class="flex items-center">
    <a class="inline-flex text-black items-center justify-center h-16 px-6" href="{{ home_url('/') }}">
      <span class="text-center leading-tight">Bag(0)</span>
    </a>
    <a class="bg-brand-yellow text-black items-center justify-center h-16 px-6 hidden lg:flex" href="{{ home_url('/') }}">
